...
public class WebSocketServerHandler extends SimpleChannelInboundHandler<Object> {
    ...
    private void handleHttpRequest(ChannelHandlerContext ctx, FullHttpRequest req) {
       ...
       //构造握手响应，本机测试
        WebSocketServerHandshakerFactory webSocketServerHandshakerFactory = new WebSocketServerHandshakerFactory("ws://localhost:80/websocket", null, false);
    ...
    private void handleWebSocketFrame(ChannelHandlerContext ctx, WebSocketFrame frame) {
        ...
        ctx.channel().write(
                new TextWebSocketFrame(request + ", Netty WebSocket Service，Now Time is：" + new java.util.Date().toString()));
    }
